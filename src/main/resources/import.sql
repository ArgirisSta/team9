...
INSERT INTO persons (address, afm, car_brand, email, name, password, plate_number, surname, user_type) VALUES('3912 Hillhaven Drive', '313615519', 'ALFA_ROMEO', 'one@abc.com', 'Giorgos', '$2a$10$phTSm.9d9SxZcKKpBgW5O.BFyvkIe.MYk/frwSC7Ku4zXPBuymTy.', 'JKD-1234', 'Giakoumis', 'ADMIN');
